...
public class ArbolBinarioBusquedaTest extends TestCase {
    ...
    public void testAlturaRamaDegeneradaDerecha(){
        ArbolBinarioBusqueda<Integer> ramaDerecha = new ArbolBinarioBusqueda<>();
    ...
    public void testAlturaConDuplicadoNoCambia(){
        ArbolBinarioBusqueda<Integer> arbolDuplicado = new ArbolBinarioBusqueda<>();
    ...
    public void testAlturaLuegoDeEliminar(){
        ArbolBinarioBusqueda<Integer> arbolChico = new ArbolBinarioBusqueda<>();
    ...
    public void testAlturaArbolCompleto(){
        ArbolBinarioBusqueda<Integer> completo = new ArbolBinarioBusqueda<>();
    ...
    public void testAlturaRamaMasLargaIzquierda(){
        ArbolBinarioBusqueda<Integer> ramaLargaIzq = new ArbolBinarioBusqueda<>();
    ...
    public void testAlturaRamaMasLargaDerecha(){
        ArbolBinarioBusqueda<Integer> ramaLargaDer = new ArbolBinarioBusqueda<>();
